...
export class Wrapper_BarHorizontal2DComponent {
  ...
  check_groupProportion(currValue:any,throwOnChange:boolean,forceUpdate:boolean):void {
    if ((forceUpdate || import3.checkBinding(throwOnChange,this._expr_18,currValue))) {
      ...
      this._changes['groupProportion'] = new import1.SimpleChange(this._expr_18,currValue);
  ...
  check_paddingProportion(currValue:any,throwOnChange:boolean,forceUpdate:boolean):void {
    if ((forceUpdate || import3.checkBinding(throwOnChange,this._expr_20,currValue))) {
      ...
      this._changes['paddingProportion'] = new import1.SimpleChange(this._expr_20,currValue);
